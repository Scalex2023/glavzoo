	...
	return (
		<div className='flex flex-col md:flex-row justify-center items-center gap-10'>

            {
                news?.docs.map(i => (
                    <div
                        className='flex justify-center relative h-[580px] items-center flex-col w-[95%] md:w-[350px] border text-center pb-10 rounded-[20px]'
                        data-aos='zoom-in'
                    >
                        <img
                            src={i.data().image}
                        ...
                        />
                        <h1 className='text-[#3a3a3a] ml-2 text-start font-bold text-[24px] mt-5'>
                            {i.data().title}
                        </h1>
